    ...
    public function insertGetAddressId($data, $customerId){
        ...
        if($addressId){
            ...
            return DB::table('addresses')->insertGetId([
                ...
                'address2'          => $originalAddress == $data[self::ADDRESS_ADDRESS_2] ? '' : $data[self::ADDRESS_ADDRESS_2],
                'address3'          => $originalAddress == $data[self::ADDRESS_ADDRESS_3] ? '' : $data[self::ADDRESS_ADDRESS_3],
